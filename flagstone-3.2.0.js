    ...
    function Flagstone(dO) {
      ...
      (function() {
        ...
        if (!document.getElementById('flagstone-' + instanceIndex + '-styles')) {
          const bedStyles = '.flagstone-' + instanceIndex + '-bed{box-sizing:border-box;list-style-type:none;position:relative;margin:0;padding:0;min-width:' + (minWidth + (stonesMargin * 2)) + 'px;}';

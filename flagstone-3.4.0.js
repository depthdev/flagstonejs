    ...
    function Flagstone(dO) {
      ...
      const dd = {
        ...
        touchMove(e) {
          ...
          while (elem && !elem.hasAttribute('draggable')) {
          ...
          if (elem) {
            ...
            } else if (!dd.targetStone.classList.contains('flagstone-lock')) {
              dd.targetStone.classList.add('flagstone-dragover');
        ...
        touchEnd() {
          if (dd.targetStone && !dd.targetStone.classList.contains('flagstone-lock') && dropCallback(dd.dropStone, dd.targetStone)) {
      ...
      resetHard = function() {
        ...
        for (;i<l;i++) {
          ...
          stones[i].removeEventListener('touchstart', dd.dragStart);
        ...
        if (dragAndDrop) {
          ...
          for (;i<l;i++) {
            ...
            stones[i].addEventListener('touchstart', dd.dragStart);

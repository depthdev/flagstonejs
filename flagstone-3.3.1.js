  ...
  window.flagstone = function(devObj) {
    ...
    function Flagstone(dO) {
      ...
      function eventResize(e) {
        ...
        let elemTop = window.parseFloat(elem.style.top); // 65% faster than Regex replace (at least on parseInt)
      ...
      (function() {
        ...
        if (!document.getElementById('flagstone-' + instanceIndex + '-styles')) {
          const bedStyles = '.flagstone-' + instanceIndex + '-bed{box-sizing:border-box;list-style-type:none;overflow:hidden;position:relative;min-width:' + (minWidth + (stonesMargin * 2)) + 'px;}';
